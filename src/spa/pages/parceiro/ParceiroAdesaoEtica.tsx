/**
 * Parceiro: Adesão Ética page
 * Same content as ConsultorAdesaoEtica but with ParceiroLayout
 */
...
import {
  FileCheck, Users, Building2, CheckCircle2, Clock,
  Search, Loader2, TrendingUp, AlertTriangle,
} from "lucide-react";
import {
  useTodasAdesoes,
...
export default function ParceiroAdesaoEtica() {
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge variant="outline">
                            <Users className="w-3 h-3 mr-1" />{org.total_adesoes}/{org.total_membros}
                          </Badge>
                          {org.percentual === 100 ? (
                            ...
                            <Badge className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300">
                              <Clock className="w-3 h-3 mr-1" />{org.percentual}%
                            </Badge>
                          ) : (
                            <Badge variant="destructive">
                              <AlertTriangle className="w-3 h-3 mr-1" />{org.percentual}%
                            </Badge>
                          )}
                        </div>
                      </div>
                  ...
                  <TableBody>
                    {adesoesFiltradas?.map((adesao) => (
                      <TableRow key={adesao.id}>
                        ...
                        <TableCell><Badge variant="outline">v{adesao.codigo_etica_versoes?.versao}</Badge></TableCell>
                        <TableCell>
