...
import { Users, Kanban, Shield, Search, Megaphone } from "lucide-react";
import { DropdownMenuItem, DropdownMenuSeparator } from "@/components/ui/dropdown-menu";

// Menu ainda cobre só as páginas que já existem (Busca, Leads, Funil, Campanhas) — Dashboard e
// Conversões entram conforme as fases seguintes do módulo Finder forem implementadas
...
const navItems: NavItem[] = [
  ...
  { icon: Megaphone, label: "Campanhas", href: "/representante/finder/campanhas", dataTour: "representante-nav-campanhas" },
];
